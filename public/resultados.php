...
<div class="page-container">
	...
	<div class="main-container">
		...
		<div class="main-content">
			<form id="formJuegos">
			<h1 class="page-title"><a href="estadisticas.php?idComp=<?php echo $idComp;?>">Estadísticas</a>/Resultados/<?php echo $competicion['nombre']; ?></h1>
			<div class="row">			
			<div class="col-lg-12">
			...
			<div class="col-lg-12">
				<div class="class="panel panel-minimal"t">
					<div class="panel-body">
						<div id="divResultadosContent"></div>						
					</div>
				</div>			
...
$(document).ready(function(){
   $("#cmbFase").change(function () {
	 idFase = $(this).val();
	 $("#divResultadosContent").load('ajaxResultados.php?idFase='+this.value+'&idComp='+idComp);	  	
   })
});
</script>
<?php $connect->close(); ?>