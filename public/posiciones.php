...
$resultFases = $connect->query( "select * from fase where activa =1 and id_competicion=".$idComp);
...
<div class="page-container">
	...
	<div class="main-container">
		...
		<div class="main-content">
			<form id="formJuegos">
			<h1 class="page-title"><a href="estadisticas.php?idComp=<?php echo $idComp;?>">Estadísticas</a>/Posiciones/<?php echo $competicion['nombre']; ?></h1>
			<div class="row">			
			<div class="col-lg-12">
					...
					<div class="panel-body">						 
						  <div class="form-group">
							...
							<select class="form-control" required id="cmbFase" name="cmbFase">
								<option value="">Seleccione una fase...</option><?php
...
$(document).ready(function(){
   $("#cmbFase").change(function () {
	 idFase = $(this).val();
	 $("#divPosicionesContent").load('ajaxPosiciones.php?idFase='+this.value+'&idComp='+idComp);	  	
   })
});	
