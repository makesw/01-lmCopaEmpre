...
$resultCompetencias = $connect->query( "select c.* from competicion c join equipo e on e.id_competicion = c.id and e.id_usuario=".$_SESSION[ 'dataSession' ]['id'] );
$idComp=0;
$resultInscripciones = $connect->query( "select i.*,e.nombre nombreEquipo, e.color, c.nombre nombreCompeticion from inscripcion i JOIN competicion c ON i.id_competicion = c.id JOIN equipo e ON i.id_equipo =e.id AND e.id_usuario =". $_SESSION[ 'dataSession' ]['id'] );
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="page-container">
	...
	<div class="main-container">
		...
		<div class="main-content">
			<h1 class="page-title">Gestión / Inscripciones</h1>
			<div class="row">			
			<div class="col-lg-12">
...
function fnInscribir(){
	if( $("#cmbComp").val() <  1 ){
		alert('Por favor seleeccione un competencia.');
			...
			idComp = $("#cmbComp").val();
			 $.post("ajaxEquipos.php?opt=4", { idComp: idComp }, function(data){					
