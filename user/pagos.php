...
<div class="page-container">
	...
	<div class="main-container">
		...
		<div class="main-content">
			<form id="formJuegos">
			<h1 class="page-title">Consultas / Mis Pagos</h1>
			<div class="row">			
			<div class="col-lg-12">
			...
			<h1 class="page-title">Estado financiero actual de tu equipo</h1>		
			<div class="row">			
			<div class="col-lg-12">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="formRegistrarAbono" method="post">					
					<div class="form-group"> 
						...
						<div class="col-sm-10"> 
							<input type="text" placeholder="$valor" id="valor" name="valor" class="form-control"  required>
						</div> 
					</div>																		
					<div class="form-group"> 
...
if( idComp != 0 ){
	$("#divPagosContent").load('ajaxPagos.php?idComp='+idComp);
	$("#cmbComp").val(idComp);
}
$(document).ready(function(){
   $("#cmbComp").change(function () {
	 $("#divPagosContent").load('ajaxPagos.php?idComp='+$("#cmbComp").val());	  	
   })
});	
