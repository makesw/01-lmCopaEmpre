...
<div class="page-container">
	...
	<div class="main-container">
		...
		<div class="main-content">
			<form id="formJuegos">
			<h1 class="page-title">Consultas / Valla Menos Vencida</h1>
			<div class="row">			
			<div class="col-lg-12">
			...
			<h1 class="page-title">Valla Menos Vencida</h1>		
			<div class="row">			
			<div class="col-lg-12">
...
$(document).ready(function(){
   $("#cmbComp").change(function () {
	 $("#divVMVContent").load('ajaxVallaMenosVencida.php?idComp='+$("#cmbComp").val());	  	
   })
});	
</script>
<?php $connect->close(); ?>