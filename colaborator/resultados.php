...
<div class="page-container">
	...
	<div class="main-container">
		...
		<div class="main-content">
			<form id="formJuegos">
			<h1 class="page-title">Consultas / Resultados</h1>
			<div class="row">			
			<div class="col-lg-12">
...
$(document).ready(function(){
   $("#cmbFase").change(function () {
	 idFase = $(this).val();
	 $("#divResultadosContent").load('ajaxResultados.php?idFase='+this.value+'&idComp='+$("#cmbComp").val());	  	
   })
});	
if( idComp != null ){
	$("#cmbComp").val(idComp);
	...
	$("#cmbFase").val(idFase);
	$("#divJuegosContent").load('ajaxJuegos.php?idFase='+idFase);	
}
</script>
<?php $connect->close(); ?>