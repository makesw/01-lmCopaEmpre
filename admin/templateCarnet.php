...
<body style="text-align: -webkit-center;font-family: Source Sans Pro, sans-serif !important;">
	<table style="width: 340px;border: none;padding-left: 15px;border-collapse:inherit;border-spacing:0px;font-family: Source Sans Pro, sans-serif !important;">
		<tr style="height: 50px;">
			<td style="width: 100%;background-color: black;" colspan="2" valign="top">
				<table>
					<tr>
						<td valign="top">
							<img style="padding-left: 5px; width: 100px !important;height: 49px !important;" src="../images/logo.png" alt="">
						</td>
						<td valign="top" style="text-align: center;padding:5px 0px 0px 2px;font-size: 14px;font-weight: bold;color: white;">
							<?php echo $player['nombreComp'];?>
						</td>
					</tr>
				</table>
			</td>			
		...
		<tr>
			<td  style="width: 50%; font-weight: 600;background-color: white;">
				<img style="padding:2px 0px 0px 2px; width: 105px !important;height: 110px !important;" src="<?php echo $player['url_foto'];?>" alt="">
			</td>
			<td style="width: 50%;font-weight: 800;text-align: left; color: black;background-color: white;">
				<table style="font-size: 12px;">
					<tr>
						<td style="font-weight: 1000;color: red;">DOCUMENTO:</td>						
					</tr>
					<tr>
						<td><?php echo $player['documento'];?></td>
					</tr>
					<tr>
						<td style="font-weight: 1000;color: red;">NOMBRE:</td>						
					</tr>
					<tr>
						<td><?php echo $player['nombres'].' '.$player['apellidos'];?></td>
					</tr>
					<tr>
						<td style="font-weight: 1000;color: red;">EQUIPO:</td>					
					</tr>
					<tr>
		...
		<tr style="height: 30px;">
			<td colspan="2" style="font-size: 12px;padding-left: 5px;font-weight: 600;background-color: red;color: black;">
