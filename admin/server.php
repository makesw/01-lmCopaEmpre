...
if ( $action == 'addUpdComp' ) {
	...
	if( $bthAction == 1 ){ //insert data
		...
		$query = "UPDATE competicion SET nombre='".$_POST["nombre"]."',puntos_ganador='".$_POST["puntosg"]."',puntos_perdedor='".$_POST["puntosp"]."',puntos_empate='".$_POST["puntose"]."',activa='".$active."',habilitar_inscripciones='".$inscription."',id_parent='".$parent."',valor=".$_POST["valor"].",nummxjug=".$_POST["maxJug"]." WHERE id = ".$_POST[ "bthValId" ];
