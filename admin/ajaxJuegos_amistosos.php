...
?>
<button class="btn btn-success" type="button" data-toggle="modal" data-target="#modal-agregar">Agregar Juego</button>
<button class="btn btn-danger" type="button" onClick="javascript:delJuegos();">Borrar Juegos</button>
