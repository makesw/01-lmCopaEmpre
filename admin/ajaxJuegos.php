...
<?php
?>
Ida y Vuelta: <input type="checkbox" name="checkIdaVuelta" /><br>
<button type="button" class="btn btn-primary" onClick="javascript:genGames(<?php echo $id;?>);">Generar/Actualizar Juegos</button>
<?php //} ?>
